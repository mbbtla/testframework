...
public class AllDriverManager {
    ...
    public AllDriverManager() {
        driverType = managers.FileReaderManager.getInstance().getConfigFileReader().getBrowser();
        environmentType = managers.FileReaderManager.getInstance().getConfigFileReader().getEnvironment();
    }
    ...
    private WebDriver createLocalDriver() {
        ...
        long time = managers.FileReaderManager.getInstance().getConfigFileReader().getTime();
